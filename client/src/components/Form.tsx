          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="d-flex flex-wrap">
              ...
              <div className="col-md-6">
                <div className="text-white bg-success rounded p-4">
                  ...
                  <div className="space-y-4">
                    <input
                      type="text"
                      name="streetNr"
                      className="form-control block w-full p-2 text-sm text-white placeholder-white bg-success border-bottom border-gray-300 focus:border-transparent focus:outline-none"
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col">
                        <select
                          name="place"
                          className="form-select block w-full p-2 text-sm text-white placeholder-white bg-success border-bottom border-gray-300 focus:border-transparent focus:outline-none"
